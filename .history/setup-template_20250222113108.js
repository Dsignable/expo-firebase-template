...
async function setupTemplate() {
    ...
    try {
        // Create template backup first
        logs.push('\nCreating template backup...');
        await copyDirectory(currentDir, templateDir);
        logs.push(`✅ Created template backup at: ${templateDir}`);
        ...
        logs.push(`\nTemplate backup created at: ${templateDir}`);
        logs.push('You can now delete this setup script.');
